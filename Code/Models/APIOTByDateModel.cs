// Root myDeserializedClass = JsonConvert.DeserializeObject<Root>(myJsonResponse);
    public class DatumOTByDate
    {
        ...
        public List<ItemOtByDate> itemOts { get; set; }
    }

    public class ItemOtByDate
    {
    ...
    public class APIOTByDateModel
    {
        public bool isSuccess { get; set; }
        public string isError { get; set; }
        public int isCode { get; set; }
        public List<DatumOTByDate> data { get; set; }
    }